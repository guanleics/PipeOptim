...
def save_translation_results(model_name, runtime_list, val_loss_list, train_loss_list):
...
def main():
    ...
    optimizer = adam.ADAMWithPipeOptim(
        r.modules(),
        r.master_parameters,
        r.model_parameters,
        args.loss_scale,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.forward_only:
            ...
            print("acc loss", args.rank, prec1, val_loss)
    ...
    if args.rank == 3:
        filename = 'PipeOptim' + '_' + args.arch + '_' + args.optimizer + '_seed' + str(args.manualSeed)
