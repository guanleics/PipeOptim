...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.forward_only:
            ...
            train(train_loader, r, optimizer, epoch, train_loss_list)
            time_end = time.time()
    ...
    if args.rank == 3:
        filename = 'XPipe_wmt' + '_' + args.arch + '_' + args.optim
        save_translation_results(filename, runtime_list, val_loss_list, train_loss_list)



def train(train_loader, r, optimizer, epoch, train_loss_list):
