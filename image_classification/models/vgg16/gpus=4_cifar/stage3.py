...
class Stage3(torch.nn.Module):
    def __init__(self):
        ...
        self.layer12 = torch.nn.AvgPool2d(kernel_size=1, stride=1, padding=0)
        self.layer15 = torch.nn.Linear(in_features=512, out_features=100, bias=True)
